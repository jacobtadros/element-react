...
test('Basic usage', function () {
  ...
  var tabs = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_src.Tabs, {
    activeName: "2",
    onTabClick: function onTabClick(tab) {
      return state.name = tab.props.name;
    }
  }, /*#__PURE__*/_react["default"].createElement(_src.Tabs.Pane, {
    label: "\u7528\u6237\u7BA1\u7406",
    name: "1"
  }, "\u7528\u6237\u7BA1\u7406"), /*#__PURE__*/_react["default"].createElement(_src.Tabs.Pane, {
    label: "\u914D\u7F6E\u7BA1\u7406",
    name: "2"
  }, "\u914D\u7F6E\u7BA1\u7406"), /*#__PURE__*/_react["default"].createElement(_src.Tabs.Pane, {
    label: "\u89D2\u8272\u7BA1\u7406",
    name: "3"
  }, "\u89D2\u8272\u7BA1\u7406"), /*#__PURE__*/_react["default"].createElement(_src.Tabs.Pane, {
    label: "\u5B9A\u65F6\u8865\u507F\u4EFB\u52A1",
    name: "4"
  }, "\u5B9A\u65F6\u8865\u507F\u4EFB\u52A1")));
...
test('Custom Tab', function () {
  var label = /*#__PURE__*/_react["default"].createElement("span", null, /*#__PURE__*/_react["default"].createElement(_src.Icon, {
    name: "date"
  }), " \u7528\u6237\u7BA1\u7406");
...
test('Add & Close tab', function () {
  ...
  var tabs = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_src.Tabs, {
    ...
    value: "Tab 2",
    editable: true,
    onTabEdit: function onTabEdit(action, tab) {
      return editTab(action, tab);
    }
  }, state.tabs.map(function (item, index) {
    return /*#__PURE__*/_react["default"].createElement(_src.Tabs.Pane, {
      key: index,
      closable: true,
      label: item.title,
      name: item.name
...
test('Customized trigger button of new tab', function () {
  ...
  var button = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_src.Button, {
    size: "small",
  ...
  var tabs = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_src.Tabs, {
    type: "card",
    value: "Tab 2",
    onTabRemove: function onTabRemove(tab) {
