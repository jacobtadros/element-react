  ...
  _createClass(Button, [{
    ...
    value: function render() {
      return /*#__PURE__*/_react["default"].createElement("button", {
        style: this.style(),
        className: this.className('el-button', this.props.type && "el-button--".concat(this.props.type), this.props.size && "el-button--".concat(this.props.size), {
      ...
      }, this.props.loading && /*#__PURE__*/_react["default"].createElement("i", {
        className: "el-icon-loading"
      }), this.props.icon && !this.props.loading && /*#__PURE__*/_react["default"].createElement("i", {
        className: "el-icon-".concat(this.props.icon)
