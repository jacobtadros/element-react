...
test('Basic usage', function () {
  var switch1 = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_src.Switch, {
    value: true,
    onText: "",
    offText: ""
  }));
  ...
  expect(switch1.find('label.el-switch').hasClass('is-checked')).toEqual(true); // switch off
  ...
  var switch2 = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_src.Switch, {
    value: true,
    onColor: "#13ce66",
    offColor: "#ff4949"
  }));
  ...
  expect(switch2.find('label.el-switch .el-switch__label').at(1).prop('style').display).toEqual('none'); // switch off

  switch2.find('input[type="checkbox"]').simulate('change', {
    target: {
      value: false
    }
  });
...
test('Extended value types', function () {
  ...
  var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement(_src.Tooltip, {
    placement: "top",
    content: /*#__PURE__*/_react["default"].createElement("div", null, "Switch value: ", state.value)
  }, /*#__PURE__*/_react["default"].createElement(_src.Switch, {
    value: state.value,
    onColor: "#13ce66",
    offColor: "#ff4949",
    onValue: 100,
  ...
  expect(state.value).toBe(100); // switch off
