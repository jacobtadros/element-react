...
var MountBody = /*#__PURE__*/function (_Component) {
  _inherits(MountBody, _Component);

  var _super = _createSuper(MountBody);
  ...
  _createClass(MountBody, [{
    ...
    value: function componentWillMount() {
      var c = /*#__PURE__*/_react["default"].cloneElement(this.props.children);

      this.tnode = document.createElement('div');
      document.body.appendChild(this.tnode);

      _reactDom["default"].render(c, this.tnode);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      _reactDom["default"].unmountComponentAtNode(this.tnode);
