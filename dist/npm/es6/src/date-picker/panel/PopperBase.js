...
var PopperBase = /*#__PURE__*/function (_Component) {
  _inherits(PopperBase, _Component);

  var _super = _createSuper(PopperBase);
  ...
  function PopperBase(props) {
    ...
    _utils.PopperReactMixin.call(_assertThisInitialized(_this), function () {
