...
test('Basic usage', function () {
  ...
  var component1 = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_src.Rate, {
  ...
  }, 1000); // 模拟component1的第三个星 click事件
  ...
  var component2 = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_src.Rate, {
...
test('With text', function () {
  var component = (0, _enzyme.mount)( /*#__PURE__*/_react["default"].createElement(_src.Rate, {
    showText: true,
...
test('Read-only', function () {
  ...
  expect(component.find('.el-rate__text').at(0).text()).toEqual('3.9'); // 模拟component的第五个星 click事件
